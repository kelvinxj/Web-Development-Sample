...
# export ZEPPELIN_NOTEBOOK_DIR=/home/hduser/ZeppelinNotebook  		# Where notebook saved
...
# export ZEPPELIN_NOTEBOOK_STORAGE=org.apache.zeppelin.notebook.repo.GitNotebookRepo  		# Refers to pluggable notebook storage class, can have two classes simultaneously with a sync between them (e.g. local and remote).
