...
<form class="semantic" method="post" action="${pageContext.request.contextPath }/book">
	<fieldset>
		<legend>
			<c:choose>
		...
		<div>
			...
			<input name="price" id="price" class="money" value="${book.price }"/>
		</div>
		<div>
			<label for="pubDate">Publication Date</label>
			<input name="pubDate" id="pubDate" class="date" value="${pubDate}"/>
