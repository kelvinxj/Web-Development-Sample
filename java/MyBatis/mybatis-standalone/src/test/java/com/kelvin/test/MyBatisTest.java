...
import com.kelvin.test.domain.associate.AuthorAndBlog;
import com.kelvin.test.domain.associate.BlogAndAuthor;
import com.kelvin.test.domain.associate.BlogAndComment;
import com.kelvin.test.mapper.BlogMapper;
import com.kelvin.test.mapper.BlogMapperExt;
...
public class MyBatisTest {
    ...
    public void testSessionApi() throws IOException {
        ...
        try {
            Blog blog = (Blog) session.selectOne("com.kelvin.test.mapper.BlogMapper.selectBlogById", 1);
