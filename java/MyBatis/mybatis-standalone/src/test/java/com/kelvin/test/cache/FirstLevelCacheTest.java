...
public class FirstLevelCacheTest {
    /**
     * 测试一级缓存需要先关闭二级缓存 cacheEnabled = false，localCacheScope确认设置为SESSION
     * @throws IOException
     */
    @Test
    ...
    public void testCacheInvalid() throws IOException {
        ...
        try {
            ...
            Blog blog = new Blog();
            blog.setBid(1);
            blog.setName("2020年2月2日02:02:02");
            // 更新了这一行数据
    ...
    public void testDirtyRead() throws IOException {
        ...
        try {
            BlogMapper mapper1 = session1.getMapper(BlogMapper.class);
            Blog old = mapper1.selectBlogById(1);
            System.out.println(old);

            // 会话2更新了数据，会话2的一级缓存更新
            Blog blog = new Blog();
            blog.setBid(1);
            blog.setName(old.getName() + "+1");
            BlogMapper mapper2 = session2.getMapper(BlogMapper.class);
