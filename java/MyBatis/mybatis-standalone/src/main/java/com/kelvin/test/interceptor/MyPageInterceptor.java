package com.kelvin.test.interceptor;
 ...
 */
/**
 * this interceptor class has some problems.
 * because method deferLoad in Executor.class has five parameters:
 * void deferLoad(MappedStatement ms, MetaObject resultObject, String property, CacheKey key, Class<?> targetType);
 */
@Intercepts({@Signature(type = Executor.class,method = "deferLoad",
