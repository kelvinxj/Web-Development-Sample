...
public class WordCount 
{
	...
	public static class WordCountMapper extends Mapper<LongWritable, Text, Text, IntWritable>{
		...
		public enum countersEnum {TOTAL_WORDS};
		
		@Override
		protected void map(LongWritable key, Text value,Mapper<LongWritable, Text, Text, IntWritable>.Context context)throws IOException, InterruptedException {
			String line = value.toString();
			StringTokenizer tokenizer = new StringTokenizer(line);
			Counter counter = context.getCounter(countersEnum.class.getName(), countersEnum.TOTAL_WORDS.toString());
	...
	public static class Reduce extends Reducer<Text, IntWritable, Text, IntWritable>{
		public enum countersEnum {TOTAL_WORDS_DISTINCT};
		...
		protected void reduce(Text key, Iterable<IntWritable> values, Context context)
			...
			Counter counter = context.getCounter(countersEnum.class.getName(), countersEnum.TOTAL_WORDS_DISTINCT.toString());
			counter.increment(1);
